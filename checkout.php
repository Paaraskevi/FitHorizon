...
<body>
    ...
    <section class="my-5 py-5">
      ...
      <div class="mx-auto container">
        <form id="checkout-form" method="POST" action="process_checkout.php">
          ...
          <div class="form-group checkout-small-element">
            <label>Email</label>
            <input type="text" class="form-control" id="checkout-email" name="email" placeholder="Enter your E-mail" required/>
          </div>
          <div class="form-group checkout-small-element">
            <label>Phone</label>
          ...
          <div class="form-group checkout-large-element">
            <input type="submit" class="btn" id="register-login-btn" value="Checkout"/>
          </div>
        </form>
      </div>
    </section>
  ...
  <footer class="footer">
    ...
    <?php
      echo date('Y');
    ?> 
    by <span>asprou paraskevi</span></div>
  </footer>
